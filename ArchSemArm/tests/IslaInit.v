...
Definition isla_init_regs :=
  ...
  |> reg_insert PSTATE $ {| ProcState_M := 0x0%bv; ProcState_EXLOCK := 0x0%bv; ProcState_PPEND := 0x0%bv; ProcState_T := 0x0%bv; ProcState_E := 0x0%bv; ProcState_Q := 0x0%bv; ProcState_I := 0x1%bv; ProcState_N := 0x0%bv; ProcState_TCO := 0x0%bv; ProcState_F := 0x1%bv; ProcState_UAO := 0x0%bv; ProcState_D := 0x1%bv; ProcState_ALLINT := 0x0%bv; ProcState_C := 0x0%bv; ProcState_IL := 0x0%bv; ProcState_SM := 0x0%bv; ProcState_PAN := 0x0%bv; ProcState_BTYPE := 0x0%bv; ProcState_SS := 0x0%bv; ProcState_nRW := 0x0%bv; ProcState_IT := 0x0%bv; ProcState_PM := 0x0%bv; ProcState_A := 0x1%bv; ProcState_ZA := 0x0%bv; ProcState_SP := 0x0%bv; ProcState_Z := 0x0%bv; ProcState_SSBS := 0x0%bv; ProcState_DIT := 0x0%bv; ProcState_GE := 0x0%bv; ProcState_EL := 0x0%bv; ProcState_J := 0x0%bv; ProcState_V := 0x0%bv |}
