...
From ArchSemRiscV Require Import RiscVInst RiscVSeqModel.
...
Definition test_results := sequential_modelc None 2 sail_riscv_sem 1%nat initState.
  ...
  Definition initState :=
    {|MState.state :=
        {|MState.memory := init_mem;
          ...
          MState.address_space := () |};
      MState.termCond := termCond |}.
  Definition test_results := sequential_modelc None 1000 sail_riscv_sem 1%nat initState.
