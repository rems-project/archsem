...
stmt:
  ...
  | KW_ALIGNED INT KW_VIRTUAL names SEMI { Decl("virtual", $4) } /* Ignoring alignment */
...
names:
  | ID { [$1] }
  | ID names { $1 :: $2 } /* Space-separated list now */
  | ID COMMA names { $1 :: $3 } /* Support commas too just in case */
...
attrs_content:
  ...
  | KW_CODE KW_AND KW_DEFAULT { true }
